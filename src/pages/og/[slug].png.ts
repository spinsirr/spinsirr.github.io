...
export const GET: APIRoute = async ({ props }) => {
	...
	const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
		...
		<rect x="844" y="114" width="12" height="452" fill="#2438ff"/><rect x="844" y="420" width="12" height="80" fill="#ec6b2d"/>
		...
		<text x="82" y="95" class="meta">SPENCER ZHAO / FIELD JOURNAL</text><text x="1118" y="95" text-anchor="end" class="meta">${escapeXml(KIND_LABELS[post.data.kind].toUpperCase())}</text>
